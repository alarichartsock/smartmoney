...
/*
List of all the data needed for our specific OnboardingPages. Includes title, description, and ID. Todo: add image.
*/
...
List<PageModel> pageList = [
  ...
  PageModel(
    "Connect",
    "Get alerts when hedge funds and investors make large trades.",
    2,
  ),
  PageModel(
    "Get an Edge",
...
class _OnboardingState extends State<Onboarding>  with SingleTickerProviderStateMixin{
  ...
  //   _fillAnimation = Tween<double>(begin: 0, end: 300).animate(controller)
  //   ..addListener(() {
  //     //changes 
  //   }
  //   );
  ...
  void jumpForward() {
    _pageController.nextPage(curve: Curves.easeIn, duration: Duration(milliseconds: 200));
  }
...
class _OnboardingPageState extends State<OnboardingPage> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    ThemeData blocData = BlocProvider.of<ThemeBloc>(context).currentState; //storing as a variable to prevent long lines. cut down if not needed.
    ...
    return Scaffold( 
        ...
        body: Container( //background
          ...
          child: Column(
            ...
            children: <Widget>[
              Material( //todo: add images to top
                borderRadius: BorderRadius.all(const Radius.circular(8.0)),
                elevation: 5.0,
                  child: Container( // Aspect ratio is 1:1.
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: BlocProvider.of<ThemeBloc>(context).currentState.canvasColor,
                  ),
              ...
              Padding(
                ...
                elevation: 5.0,
                  child: Container( // Aspect ratio is 1:1.
                  width: _containerWidth,
                  height: 3/4 * (_containerWidth - _margin),
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.all(
                      const Radius.circular(8.0)
                    ),
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        padding: const EdgeInsets.only(top: _margin * 2, left: _margin, right: _margin),
                        child: Text("$title", style: blocData.textTheme.display3, textAlign: TextAlign.center,),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(top: _margin, left: _margin, right: _margin),
                        child: Text("$description", style: blocData.textTheme.title,textAlign: TextAlign.center,),
                      ),
                      Padding(
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: GestureDetector(
                                child: Text("NEXT", style: blocData.textTheme.button),
                                onTap: () {
                                  nextPressed();
                                },
                                ),
                ...
                elevation: 5.0,
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        padding: const EdgeInsets.only(top: _margin),
                        child: Text("Smartmoney", style: blocData.textTheme.display3,),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(top: _padding),
                        child: Text("Elevate your trading.", style: blocData.textTheme.title,),
                      ),
                      Padding(
                        padding: EdgeInsets.only(top: 32),
                        child: Row(
