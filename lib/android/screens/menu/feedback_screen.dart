...
//Alaric todo: give each user 10 or so allowed feedbacks to avoid spam. Waiting until accounts are a thing.
  ...
  Widget build(BuildContext context) {
    ...
    void _sendToServer(String localTitle, String localDescription) {
      if ((title == null || title =="") || (description == null || description == "")) { //So ugly. Sorry guys.
        Toast.show(
            "Please fill in both text fields before submitting.", context,
            duration: 2,
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: StyledButton(
                              ...
                              text: "SEND",
                              onPressed: () {
                                FocusScope.of(context).requestFocus(new FocusNode()); // Lowers any keyboards.
